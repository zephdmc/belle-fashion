                ...
                <div className="container mx-auto px-4">
                    <div className="flex justify-center items-center h-96">
                        <div className="text-center">
                            <Loader />
                            <p className="mt-4 text-gray-600 font-medium font-serif">Loading products...</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 max-w-7xl">
                ...
                >
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8">
                        <div>
                            <h1 className="text-3xl font-bold text-black mb-2 font-serif">Fashion Product Management</h1>
                            <p className="text-gray-700 font-serif">Manage your fashion catalog, inventory, and collections</p>
                        </div>
                        <div className="flex flex-col sm:flex-row gap-4 mt-4 lg:mt-0">
                            <button
                                onClick={refreshProducts}
                                className="flex items-center bg-gold text-black hover:bg-yellow-500 py-3 px-6 rounded-xl border border-gold hover:shadow-lg transition-all duration-200 font-semibold font-serif"
                            >
                            ...
                            <Link
                                ...
                                className="flex items-center bg-gradient-to-r from-gold to-yellow-600 text-black py-3 px-6 rounded-xl hover:shadow-lg transition-all duration-200 font-semibold font-serif border border-gold"
                            >
                        ...
                        {[
                            ...
                            >
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-xl font-bold text-black font-serif">{value}</p>
                    ...
                    <div className="bg-white rounded-2xl border border-gray-300 p-6 shadow-sm">
                        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                            <div className="flex items-center">
                                ...
                                <h3 className="text-lg font-semibold text-black font-serif">Filter Products</h3>
                            </div>
                ...
                <AnimatePresence mode="wait">
                    {filteredProducts.length > 0 ? (
                                        ...
                                        <tbody className="bg-white divide-y divide-gray-200">
                                            {filteredProducts.map((product, index) => (
                                                ...
                                                >
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <div className="flex items-center">
                                                            <img
                                                                ...
                                                                alt={product.name}
                                                                className="h-12 w-12 object-cover rounded-xl border border-gray-300 mr-4"
                                                                onError={(e) => {
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="flex items-center gap-2 mt-1">
                                                                    {product.isFeatured && (
                                                                        <span className="inline-flex items-center px-2 py-1 rounded text-xs font-semibold bg-purple-100 text-purple-800 border border-purple-300">
                                                                            <FiStar className="mr-1" size={10} />
                                                                            Featured
                                                                        </span>
                                                                    )}
                                                                    {product.isNewArrival && (
                                                                        <span className="inline-flex items-center px-2 py-1 rounded text-xs font-semibold bg-blue-100 text-blue-800 border border-blue-300">
                                                                            New
                                                                        </span>
                                                                    )}
                                                                </div>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <code className="text-xs text-gray-600 bg-gray-100 px-2 py-1 rounded border border-gray-300 font-serif">
                                                            {product.sku || 'N/A'}
                                                        </code>
                                                    </td>
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <div className="flex items-center">
                                                            ...
                                                            {product.originalPrice > product.price && (
                                                                <span className="text-xs text-gray-500 line-through ml-2 font-serif">
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <div className="flex flex-col">
                                                            <span className="text-sm text-black capitalize font-serif">
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap">
                                                        <div className="flex flex-col gap-1">
                                                            ...
                                                            {product.isCustomizable && (
                                                                <span className="inline-flex items-center px-2 py-1 rounded text-xs font-semibold bg-pink-100 text-pink-800 border border-pink-300 font-serif">
                                                                    Customizable
                                                                </span>
                                                            )}
                                                        </div>
                                                    ...
                                                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                                        <div className="flex items-center justify-end space-x-3">
                                                            ...
                                                            <button
                                                                ...
                                                                className="flex items-center text-red-600 hover:text-red-700 font-semibold disabled:opacity-50 transition-colors duration-200 font-serif"
                                                            >
                                    ...
                                    >
                                        <div className="flex items-start space-x-4">
                                            <img
                                                src={product.images?.[0] || '/placeholder-fashion.png'}
                                                alt={product.name}
                                                className="h-20 w-16 object-cover rounded-xl border border-gray-300 flex-shrink-0"
                                                onError={(e) => {
                                                    e.target.src = '/placeholder-fashion.png';
                                                }}
                                            />
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-start justify-between">
                                                    <div>
                                                        <h3 className="font-semibold text-black truncate font-serif">
                                                            {product.name || 'Untitled Product'}
                                                        </h3>
                                                        <code className="text-xs text-gray-600 mt-1 font-serif">
                                                            {product.sku || 'No SKU'}
                                                        </code>
                                                    </div>
                                                ...
                                                <div className="flex items-center gap-2 mt-2">
                                                    ...
                                                    {product.isCustomizable && (
                                                        <span className="inline-flex items-center px-2 py-1 rounded text-xs font-semibold bg-pink-100 text-pink-800 border border-pink-300">
                                                            Customizable
                                                        </span>
                                                    )}
                                                </div>
                                                ...
                                                <div className="grid grid-cols-2 gap-4 mt-3">
                                                    <div className="bg-gray-50 rounded-lg p-2 border border-gray-200">
                                                        <p className="text-xs text-gray-600 font-serif">Price</p>
                                                        <p className="text-sm font-semibold text-black font-serif">
                                                            ${product.price?.toLocaleString() || '0'}
                                                        </p>
                                                    </div>
                                                    <div className="bg-gray-50 rounded-lg p-2 border border-gray-200">
                                                        <p className="text-xs text-gray-600 font-serif">Stock</p>
                                                ...
                                                <div className="mt-3">
                                                    <p className="text-xs text-gray-600 font-serif">Category</p>
                                        ...
                                        <div className="flex items-center justify-between mt-4 pt-4 border-t border-gray-200">
                                            <div className="flex space-x-3">
                                                <Link
                                                    to={`/admin/products/${product.id}/edit`}
                                                    className="flex items-center text-gold hover:text-yellow-600 font-semibold text-sm transition-colors duration-200 font-serif"
                                                >
                                                    <FiEdit className="mr-1" />
                                                    Edit
                                                </Link>
                                                <button
                                                    onClick={() => handleDelete(product.id)}
                                                    disabled={deletingProduct === product.id}
                                                    className="flex items-center text-red-600 hover:text-red-700 font-semibold text-sm disabled:opacity-50 transition-colors duration-200 font-serif"
                                                >
                                                    {deletingProduct === product.id ? (
                        ...
                        >
                            ...
                            <h3 className="text-2xl font-bold text-black mb-4 font-serif">No Products Found</h3>
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                {(searchQuery || categoryFilter !== 'all' || stockFilter !== 'all' || statusFilter !== 'all' || typeFilter !== 'all') && (
                                    <button
                                        ...
                                        className="bg-gray-100 text-gray-700 py-3 px-6 rounded-xl border border-gray-300 hover:bg-gray-200 hover:text-black transition-all duration-200 font-semibold font-serif"
                                    >
                                        Clear Filters
                                    </button>
                                )}
                                <Link
                                    to="/admin/products/new"
                                    className="bg-gradient-to-r from-gold to-yellow-600 text-black py-3 px-6 rounded-xl hover:shadow-lg transition-all duration-200 font-semibold font-serif border border-gold"
                                >
