...
const statusConfig = {
    consultation: { color: 'bg-blue-100 text-blue-800 border-blue-300', icon: FiClock, label: 'Consultation' },
    design: { color: 'bg-purple-100 text-purple-800 border-purple-300', icon: FiEdit3, label: 'Design' },
    measurement: { color: 'bg-indigo-100 text-indigo-800 border-indigo-300', icon: FiMapPin, label: 'Measurement' },
    production: { color: 'bg-orange-100 text-orange-800 border-orange-300', icon: FiScissors, label: 'Production' },
    fitting: { color: 'bg-pink-100 text-pink-800 border-pink-300', icon: FiUser, label: 'Fitting' },
    ready: { color: 'bg-green-100 text-green-800 border-green-300', icon: FiPackage, label: 'Ready' },
    shipped: { color: 'bg-teal-100 text-teal-800 border-teal-300', icon: FiTruck, label: 'Shipped' },
    delivered: { color: 'bg-emerald-100 text-emerald-800 border-emerald-300', icon: FiCheckCircle, label: 'Delivered' },
    cancelled: { color: 'bg-red-100 text-red-800 border-red-300', icon: FiXCircle, label: 'Cancelled' }
};
                ...
                <div className="container mx-auto px-4">
                    <div className="flex justify-center items-center h-96">
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 font-medium font-serif">Loading custom fashion orders...</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="container mx-auto px-4 max-w-7xl">
                ...
                >
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
                        <div>
                            <h1 className="text-3xl font-bold text-black mb-2 font-serif">Custom Fashion Orders</h1>
                            <p className="text-gray-700 font-serif">Manage and track all custom design orders</p>
                        </div>
                        <button
                            onClick={loadOrders}
                    ...
                    <div className="bg-white rounded-2xl border border-gray-300 p-6 shadow-sm">
                        <div className="flex items-center justify-between mb-4">
                            <h2 className="text-lg font-semibold text-black flex items-center font-serif">
                                <FiFilter className="mr-3 text-gray-600" />
                                Filter Orders
                            </h2>
                                ...
                                <button
                                    ...
                                    className={`p-3 rounded-xl text-left transition-all duration-200 border ${
                                        filter === value 
                                            ...
                                            : 'bg-gray-50 border-gray-300 hover:bg-gold/10 hover:border-gold'
                                    }`}
                                >
                                    <div className="flex items-center justify-between mb-1">
                                        <div className={`w-2 h-2 rounded-full ${color}`}></div>
                                        <span className="text-lg font-bold text-black font-serif">{count}</span>
                                    </div>
                                    <p className="text-xs font-medium text-gray-700 leading-tight font-serif">{label}</p>
                                </button>
                            ))}
                        </div>
                    </div>
                            ...
                            {filteredOrders.map((order, index) => {
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className="bg-white rounded-2xl border border-gray-300 overflow-hidden hover:border-gold hover:shadow-lg transition-all duration-300 group shadow-sm"
                                    >
                                        {/* Order Header */}
                                        <div className="bg-gradient-to-r from-gold/20 to-yellow-600/20 px-6 py-4 border-b border-gray-300">
                                            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                                                <div className="flex items-center mb-4 lg:mb-0">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="flex flex-wrap items-center text-gray-600 text-sm mt-1 gap-3 font-serif">
                                                            <div className="flex items-center">
                                                ...
                                                <div className="flex flex-col sm:flex-row sm:items-center gap-4">
                                                    <div className="text-right">
                                                        ...
                                                        <p className="text-gray-600 text-sm font-serif capitalize">
                                                    ...
                                                    <div className="flex items-center">
                                                        <select 
                                                            ...
                                                            className="bg-white text-black border border-gray-300 rounded-lg py-2 px-3 text-sm font-semibold focus:outline-none focus:ring-2 focus:ring-gold focus:border-transparent disabled:opacity-50 font-serif"
                                                        >
                                        ...
                                        <div className="p-6">
                                            <div className="grid grid-cols-1 xl:grid-cols-2 gap-8">
                                                {/* Design Details */}
                                                <div>
                                                    <h4 className="font-semibold text-black mb-4 flex items-center font-serif">
                                                    ...
                                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                        {[
                                                            ...
                                                            value && (
                                                                <div key={label} className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                                                                    <span className="text-xs font-medium text-gray-600 block mb-1 font-serif">
                                                                        {label}
                                                                    </span>
                                                                    <span className="text-sm font-semibold text-black font-serif capitalize">
                                                                        {value}
                                                                    </span>
                                                                </div>
                                                            )
                                                        ...
                                                        {order.styleDescription && (
                                                            <div className="sm:col-span-2 bg-gold/10 rounded-lg p-3 border border-gold/20">
                                                                <span className="text-xs font-medium text-black block mb-1 font-serif">
                                                                    Style Description
                                                                </span>
                                                    ...
                                                    {(hasArrayItems(order.designFeatures) || hasArrayItems(order.embellishments)) && (
                                                        <div className="mt-4">
                                                            <h5 className="text-sm font-medium text-gray-600 mb-2 font-serif">Design Features</h5>
                                                            <div className="flex flex-wrap gap-2">
                                                                {hasArrayItems(order.designFeatures) && order.designFeatures.map((feature, idx) => (
                                                                    <span key={idx} className="bg-blue-100 text-blue-800 px-2 py-1 rounded text-xs border border-blue-300">
                                                                        {feature}
                                                                    </span>
                                                                ))}
                                                                {hasArrayItems(order.embellishments) && order.embellishments.map((embellishment, idx) => (
                                                                    <span key={idx} className="bg-pink-100 text-pink-800 px-2 py-1 rounded text-xs border border-pink-300">
                                                                        {embellishment}
                                                                    </span>
                                                                ))}
                                                            </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="space-y-4">
                                                        ...
                                                        {order.measurements && Object.keys(order.measurements).length > 0 && (
                                                            <div>
                                                                <h5 className="text-sm font-medium text-gray-600 mb-2 font-serif">Body Measurements</h5>
                                                                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                                                                    {Object.entries(order.measurements).map(([key, value]) => (
                                                                        value && (
                                                                            <div key={key} className="bg-gray-50 rounded p-2 text-center border border-gray-200">
                                                                                <span className="text-xs text-gray-600 block capitalize font-serif">
                                                                                    {key}
                                                                                </span>
                                                                                <span className="text-sm font-semibold text-black font-serif">
                                                                                    {value}
                                                        ...
                                                        {order.deliveryAddress && Object.keys(order.deliveryAddress).length > 0 && (
                                                            <div className="bg-gray-50 rounded-lg p-3 border border-gray-200">
                                                                <h5 className="text-sm font-medium text-gray-600 mb-2 flex items-center font-serif">
                                                        ...
                                                        {order.specialRequests && (
                                                            <div className="bg-yellow-50 rounded-lg p-3 border border-yellow-200">
                                                                <span className="text-xs font-medium text-yellow-800 block mb-1 font-serif">
                                                                    Special Requests
                                                                </span>
                                                                <span className="text-sm font-semibold text-black font-serif">
                                                                    {order.specialRequests}
                                                        ...
                                                        {hasArrayItems(order.inspirationImages) && (
                                                            <div className="bg-gray-50 rounded-lg p-4 border border-gray-200">
                                                                <h5 className="text-sm font-medium text-gray-600 mb-3 flex items-center font-serif">
                                                                ...
                                                                <div className="grid grid-cols-2 gap-2">
                                                                    {order.inspirationImages.slice(0, 4).map((image, index) => (
                                                                        <img 
                                                                            ...
                                                                            className="h-24 w-full object-cover rounded-lg border border-gray-300 bg-white cursor-pointer hover:opacity-80 transition-opacity"
                                        ...
                                        <div className="bg-gray-50 px-6 py-4 border-t border-gray-200">
                                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                                <div className="flex items-center">
                                                    <StatusIcon className={`text-sm mr-2 text-gray-600`} />
                                                    ...
                                                    {order.assignedDesigner && order.assignedDesigner !== 'Not assigned' && (
                                                        <span className="ml-3 text-sm text-gray-600 font-serif">
