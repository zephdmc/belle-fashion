...
const OrderTypeBadge = ({ orderType }) => {
    const typeConfig = {
        standard: { color: 'bg-blue-500/20 text-blue-300 border-blue-500/30', text: 'Ready-to-Wear', icon: FiShoppingBag },
                ...
                >
                    <div className="bg-gradient-to-r from-purple-500/20 to-pink-500/20 px-6 py-4 border-b border-white/20">
                        <h2 className="text-xl font-semibold text-white flex items-center gap-3">
                            <FiScissors className="text-purple-300" />
                    ...
                    <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="md:col-span-2">
                            <h3 className="text-lg font-semibold text-white mb-4 flex items-center gap-2">
                                <FiEdit3 className="text-purple-300" />
                                Design Specifications
                            </h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {[
                                    ...
                                    >
                                        <h4 className="text-sm font-medium text-purple-300 mb-1">{item.label}</h4>
                                ...
                                <div className="flex flex-wrap gap-2">
                                    ...
                                    {customOrder.embellishments?.map((embellishment, idx) => (
                                        <motion.span
                                            key={idx}
                                            variants={itemVariants}
                                            className="bg-pink-500/20 text-pink-300 px-3 py-2 rounded-xl text-sm border border-pink-500/30"
                                        >
                                            {embellishment}
                                        </motion.span>
                                    ))}
                        ...
                        <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            {customOrder.requiredByDate && (
                                <motion.div variants={itemVariants} className="bg-white/5 rounded-xl p-4 border border-white/10">
                                    <h4 className="text-sm font-medium text-purple-300 mb-1">Required By</h4>
                                    <p className="text-white font-medium">
                        ...
                        {customOrder.specialRequests && (
                            <motion.div variants={itemVariants} className="md:col-span-2 bg-yellow-500/10 rounded-xl p-4 border border-yellow-500/20">
                                ...
                                <p className="text-white whitespace-pre-wrap">{customOrder.specialRequests}</p>
                            </motion.div>
                        )}
                        ...
                        {customOrder.inspirationImages?.length > 0 && (
                            <motion.div variants={itemVariants} className="md:col-span-2">
                                <h4 className="text-lg font-semibold text-white mb-4">Inspiration Images</h4>
                                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    {customOrder.inspirationImages.map((image, idx) => (
                                        <motion.div
                                            key={idx}
                                            whileHover={{ scale: 1.05 }}
                                            className="relative rounded-2xl overflow-hidden border-2 border-white/20 cursor-pointer"
                                        ...
                                        >
                                            ...
                                            />
                                            <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-end justify-center p-2">
                ...
                {order.trackingNumber ? (
                    <div className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <motion.div variants={itemVariants} className="bg-white/5 rounded-xl p-4 border border-white/10">
                                <h3 className="text-sm font-medium text-purple-300 mb-1">Courier</h3>
                                <p className="text-white font-medium text-lg">{order.shippingCarrier}</p>
                            </motion.div>
                            <motion.div variants={itemVariants} className="bg-white/5 rounded-xl p-4 border border-white/10">
                                <h3 className="text-sm font-medium text-purple-300 mb-1">Tracking Number</h3>
                                <p className="text-white font-medium text-lg font-mono">{order.trackingNumber}</p>
                            </motion.div>
                        </div>
                        
                        {order.shippedAt && (
                            <motion.div variants={itemVariants} className="bg-green-500/10 rounded-xl p-4 border border-green-500/20">
                        ...
                        {order.estimatedDeliveryDate && (
                            <motion.div variants={itemVariants} className="bg-blue-500/10 rounded-xl p-4 border border-blue-500/20">
                                <h3 className="text-sm font-medium text-blue-300 mb-1">Estimated Delivery</h3>
                                <p className="text-white font-medium">
                        ...
                        <motion.div variants={itemVariants} className="text-center">
                            <p className="text-white/70 mb-4">Track your package on the courier's website</p>
                            <motion.a
                    ...
                    <motion.div variants={itemVariants} className="text-center py-8">
                        <FiPackage className="text-4xl text-white/50 mx-auto mb-4" />
                        <h3 className="text-lg font-semibold text-white mb-2">Tracking Not Available</h3>
                        <p className="text-white/70">Tracking information will be available once your order ships.</p>
                    </motion.div>
                )}
            </div>
        </motion.div>
                                            ...
                                            >
                                                <div className="flex-shrink-0">
                                                    <div className="relative">
                                                        <img
                                                            className="h-20 w-16 rounded-2xl object-cover border-2 border-white/20"
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <div className="flex flex-wrap gap-2 mt-2">
                                                        ...
                                                        {item.color && (
                                                            <span className="text-sm text-pink-300 bg-pink-500/20 px-2 py-1 rounded">
                                                                Color: {item.color}
                                                            </span>
                                                        )}
                                                    </div>
                                    ...
                                    <div className="p-6 space-y-4">
                                        ...
                                        {order.deliveryInstructions && (
                                            <div className="bg-yellow-500/10 rounded-xl p-4 border border-yellow-500/20">
                                                ...
                                                <p className="text-white text-sm">{order.deliveryInstructions}</p>
                                            </div>
                                        )}
                                    </div>
                                </motion.div>
