...
export default function AddProductPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.success) {
                setSuccess('Fashion item created! Redirecting...');
            ...
            <div className="container mx-auto px-4 max-w-6xl">
                ...
                <div className="mb-8">
                    <div className="flex items-center mb-6">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900 mb-2">Add New Fashion Item</h1>
                            <p className="text-gray-600">Create a new fashion product for your store</p>
                        </div>
                    </div>
                </div>
