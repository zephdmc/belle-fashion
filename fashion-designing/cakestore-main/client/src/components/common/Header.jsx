...
export default function Header() {
    ...
    // Scroll effect for header behavior - becomes absolute when scrolled
    useEffect(() => {
        const handleScroll = () => {
    ...
    // Dynamic classes based on scroll state - fixed when not scrolled, absolute when scrolled
    const headerClass = `left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled 
            ? 'absolute bg-white/95 backdrop-blur-sm shadow-md border-b border-gray-200' 
